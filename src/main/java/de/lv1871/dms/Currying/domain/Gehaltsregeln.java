...
public class Gehaltsregeln {
	...
	public static Function<Double, Double> STANDARD_STEUERSATZ_ABZIEHEN = STEUERSATZ_ABZIEHEN.curry().apply(0.54);
	public static Function<Double, Double> ZULAGE_ADDIEREN = SUM.curry().apply(102.0);
